...
- **Radeon 780M / Strix Point iGPUs** (gfx1103 / gfx1150):
...
- **Strix Halo (Radeon 8060S, gfx1151)**: either package works. Its 40-CU GPU
  is far above 780M-class iGPUs, so the HIP backend is worthwhile here.
